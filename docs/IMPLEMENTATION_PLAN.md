...
- **Q4 — Bundled reference INPs.** ✅ **Do not bundle client models.**
  ...
  scratch under the project's own Apache-2.0 license. Each scenario is
...
All scenarios are authored from scratch under the project's Apache-2.0 license.
...
- All input data (geometry, hyetographs, cost curves, tidal curves) is
  authored from scratch under the project's Apache-2.0 license. No client
